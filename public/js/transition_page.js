...
content_page2 = [
    `
        <h2> Identité </h2>
                            ...
                            <p>𝓟𝓻𝓮𝓷𝓸𝓶: 𝐻𝑜𝓀𝑜</p>
                            <br>
                            <p>𝓛𝓲𝓮𝓾 𝓭𝓮 𝓝𝓪𝓲𝓼𝓼𝓪𝓷𝓬𝓮: 𝒱𝒾𝓁𝓁𝒶𝑔𝑒 𝒹𝑒 𝒯𝒶𝓀𝓊𝓂𝒾</p>
                            <p>𝓣𝓪𝓲𝓵𝓵𝓮: 142𝒸𝓂</p>
                            <p>𝓐𝓰𝓮: 12 𝒶𝓃𝓈</p>
                            <p>𝓝𝓪𝓽𝓾𝓻𝓮𝓼 𝓭𝓮 𝓬𝓱𝓪𝓴𝓻𝓪: 𝒮𝓊𝒾𝓉𝑜𝓃 & 𝒦𝒾𝓂𝒾𝓃𝒶𝓇𝒾</p>
                            <br>
                            <p>𝓠𝓾𝓪𝓵𝓲𝓽𝓮́𝓼:  𝒯𝑒̂𝓉𝑒 𝓅𝑒𝓃𝓈𝒶𝓃𝓉𝑒, 𝒜𝑔𝒾𝓉 𝒶𝓊 𝓁𝒾𝑒𝓊 𝒹𝑒 𝓅𝒶𝓇𝓁𝑒𝓇, 𝒮𝓉𝓇𝒾𝒸𝓉 𝒶𝓋𝑒𝒸 𝓁𝓊𝒾-𝓂𝑒̂𝓂𝑒 𝑒𝓉 𝓁𝑒𝓈 𝒶𝓊𝓉𝓇𝑒𝓈, 𝒜𝓊𝓉𝑜𝓃𝑜𝓂𝑒, 𝒞𝑜𝓂𝓅𝑜𝓇𝓉𝑒𝓂𝑒𝓃𝓉 𝒹𝑒 𝓁𝑒𝒶𝒹𝑒𝓇</p>
                            <br>
                            <p>𝓓𝓮́𝓯𝓪𝓾𝓽𝓼: 𝐸𝑔𝑜𝒾̈𝓈𝓉𝑒, 𝓉𝓇𝑜𝓅 𝓈𝑒́𝓇𝒾𝑒𝓊𝓍, 𝒶𝒾𝓂𝑒 𝓉𝑜𝓊𝓉 𝒸𝑜𝓃𝓉𝓇𝑒𝓁𝑒𝓇 𝑒𝓉 𝓂𝒶𝓊𝓋𝒶𝒾𝓈𝑒 𝒸𝑜𝓂𝓅𝓇𝑒́𝒽𝑒𝓃𝓈𝒾𝑜𝓃 𝒹𝑒𝓈 𝓈𝑒𝓃𝓉𝒾𝓂𝑒𝓃𝓉𝓈</p>
                            <br>
                            <br>
                            <p>𝓝𝓸𝓶 𝓜𝓮𝓻𝓮 : 𝒪𝓀𝒶𝓃𝒶 𝒴𝑜𝓀𝒶</p>
                            <p>𝓝𝓸𝓶 𝓟𝓮𝓻𝓮 : </p>
                            <br>
                            <p>𝓛𝓲𝓮𝓾𝔁 𝓭𝓮 𝓡e𝓼𝓲𝓭𝓮𝓷𝓬𝓮 : 𝒟𝑜𝓂𝒶𝒾𝓃𝑒 𝒮𝑒𝓃𝒿𝓊</p>
